...
const rawQuizData = {
  lore: {
    ...
    advanced: [
      ...
      ["Because Michelle's ring acts as a conduit, what scaling mechanic can she tap into?", "His divine scaling power (HIMMAGE)", "The 14-Rank RF system", "The X+1 limit", "The Memory Lock"],
...
export default function App() {
  ...
  const shuffle = (array) => {
    ...
    for (let i = shuffled.length - 1; i > 0; i--) {
      ...
      const j = Math.floor((randomValues[0] / 0x100000000) * (i + 1));
