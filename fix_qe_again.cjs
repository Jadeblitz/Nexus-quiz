...
// I need to add selectedSubject, sessionXp, lastPassesNeeded to QuizEngine extraction
qe = qe.replace(
...
const searchStr = `{gameState === 'results' && (
...
const replaceStr = `{gameState === 'results' && (function() {
...
qe = qe.replace(searchStr, replaceStr);
